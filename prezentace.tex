...
\projectinfo{
  ...
  title={Protokol pro bezpečné sdílení dat \\ v peer-to-peer systémech}, % Název prezentace / Presentation title (The whole title of the presented work suitably divided into lines that are optically balanced)
